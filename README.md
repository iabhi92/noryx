...
- Deliberately not in this pass: the in-page floating "MeowMentor Coach" overlay (PRD §15) — the surface
...
4. Open a problem page on any supported site (e.g. `leetcode.com/problems/...`). A session should
   start automatically. Submit a solution, then click the MeowMentor toolbar icon to see it show up in
   the dashboard.
